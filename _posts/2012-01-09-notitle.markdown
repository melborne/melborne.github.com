...
[sleep sortに対抗してrunning sortだ！（Ruby版｜失敗に終わる編） - hp12c](http://d.hatena.ne.jp/keyesberry/20110628/p1)
...
配置し直しただけだよ
この前投稿した[Rubyで連続数字をハイフンでつなぐよ](http://d.hatena.ne.jp/keyesberry/20120107/p1)
のときに気が付いたんだ
